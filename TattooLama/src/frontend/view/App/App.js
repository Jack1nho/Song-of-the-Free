      ...
      <div className="wrapper">
        ...
        <div className="jumbotron jumbotron-fluid Jumbotron-1">
          ...
          <div className="container-wrapper">
            <h1 className="text-1">Migliori tatuatori di Milano</h1>
              <Slider></Slider>
            <div className="text-center text-md-left"><a className="text-2" href="list_tattooer.html">Vedi tutti i migliori tatuatori ></a></div>
          </div>
          ...
          <div className="container-wrapper">
            ...
            <div className="text-center text-md-left"><a className="text-2" href="list_design.html">Vedi tutti i tatuaggi ></a></div>
