                    ...
                    <div className="row">
                        <div className="col-12 col-md-8 my-2">
                            ...
                            <div className="col-12 d-md-none pl-0 my-3">
                                <img src="https://via.placeholder.com/221x157" className="img-artist"/>
                            </div>
                        ...
                        <div className="col-12 col-md-4 d-none d-md-block">
                            <img src="https://via.placeholder.com/221x157" className="img-artist float-md-right float-left"/>
                        </div>
                    </div>
                </div>
        );
