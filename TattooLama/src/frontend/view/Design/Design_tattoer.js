                    ...
                    <div className="row">
                        <div className="col-12 col-md-8 my-2">
                            ...
                            <div className="col-12 d-md-none pl-0 my-3">
                                <img src={'../images/tatuatori/img/' + this.props.tattooer.image} className="img-artist" alt="" />
                            </div>
                            <div className="normal-text mt-2">{this.props.tattooer.biography}</div>
                        </div>
                        <div className="col-12 col-md-4 d-none d-md-block">
                            <img src={'../images/tatuatori/img/' + this.props.tattooer.image} className="img-artist float-md-right float-left" alt="" />
                        </div>
                    </div>
                </div>
        );
