                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md">
                            ...
                            <div className="row div-prezzo mt-5">
                                <div className="col-6 col-md-12"><h2 className="text-3 prezzo mt-2 ml-md-auto"><span className="grey">Prezzo: </span>€ 450,00</h2></div>
                                <div className="col-6 col-md-12 pl-0"><button type="button" className="btn bottone-richiesta mt-0" id="bottone-richiesta" data-toggle="modal" data-target="#myModalEmail">Invia richiesta</button></div>
                            </div>
                        </div>
                    </div>
                </div>
